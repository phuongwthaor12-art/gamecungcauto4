...
<body>
  ...
  <!-- Bạn có thể thay link trên bằng file "sai.mp3" để chạy offline -->
  ...
  <script>
    const events = [
     ...
     { text: "📈 Vàng tăng giá khi USD suy yếu — người dân đổ xô mua tích trữ.", options: ["Cung giảm","Cầu tăng","Cung tăng","Cầu giảm"], answer: "Cầu tăng" },
